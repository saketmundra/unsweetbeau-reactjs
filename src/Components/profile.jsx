  ...
  return (
    <div className="profile">
      <div className="c1">
        <div className="p2">
          <img
            src="https://images.squarespace-cdn.com/content/v1/5bcde1c6797f744670f7c23e/1581659278805-OZD5DKLCYR5MIOLAY8BH/image-asset.jpeg?format=1500w"
            alt="Avatar"
            width="100%"
            height="100px"
            className="pimg1"
            // style="width: 50px; height: 107px; object-fit: fill;"
          />
          <img
        ...
        <div className="pr1">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem ab ipsum eum perspiciatis placeat ipsam ipsa laudantium esse quod, suscipit nihil pariatur voluptatem rerum debitis optio dolorem totam nobis cupiditate?
        </div>
        <div className="r1">
