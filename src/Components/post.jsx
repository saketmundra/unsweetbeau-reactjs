...
const post = () => {
  return (
    <div className='post'>
        ...
        <div className="r1 p1">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum, pariatur laudantium? Quod tenetur soluta rerum? Repudiandae inventore ea,
            <br/><br/>
            #skincare #beautyinside #makeup #skincareroutine #selfcare #skincoreproducts #skincoretips #antiaging #glowingskin
        </div>
        <div className="r1 p1">
        <img
            src="https://www.lek.com/sites/default/files/hero-images/insights/2348-Mens-BPC-hero.png"
            alt="Avatar"
            width="100%"
            height="200px"
            borderRadius="10px"
        ...
        <hr />
        <div className="ls">
            <div className='ic'><FavoriteIcon/>
            100+ Likes</div>
            <div className='ic'><CommentIcon/>
            Comment</div>
            <div className='ic'><SendIcon/>
            Share</div>
            <div className='ic'><BookmarkBorderIcon/>
            Save</div>
        </div>
      </div>
    </div>
